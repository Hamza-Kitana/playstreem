...
const STEPS = [
  ...
  },
  {
    ...
    body: "من الشريط العلوي افتح «الخدمات» واختر: أسئلة، كراسي، التصويت، تقييم، الجملة، أو اعرف العلم. وفيه كمان من نحن، تواصل معنا، والستريمر الموثقين. الاتصال يبقى شغّال وأنت تتنقل.",
  },
  {
    icon: Brain,
    title: "أسئلة وأجوبة",
  ...
  },
  {
    ...
    title: "الجملة",
    body: "تكتب جملة معيّنة، واللي يكتبها بالشات يطلع اسمه بهالة كبيرة على الشاشة — مرة واحدة لكل مشاهد.",
  },
  {
    icon: Flag,
    title: "اعرف العلم",
