...
const STEPS = [
  ...
  },
  {
    ...
    body: "من الشريط العلوي افتح «الخدمات» واختر: أسئلة، كراسي، التصويت، تقييم، أو الجملة. وفيه كمان من نحن، تواصل معنا، والستريمر الموثقين. الاتصال يبقى شغّال وأنت تتنقل.",
  },
  {
    icon: Brain,
    title: "أسئلة وأجوبة",
