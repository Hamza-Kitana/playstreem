...
const SERVICES = [
  ...
  {
    icon: Armchair,
    title: "كراسي الاعتراف",
    desc: "اختيار عشوائي للجالس، والجمهور يرسل أسئلته بعلامة استفهام مباشرة من الشات.",
    to: "/seat" as const,
  },
  {
    icon: Flame,
...
const STEPS = [
  ...
  "من صفحة الربط حط رابط كيك أو اسم القناة واضغط «ربط القناة»، أو استخدم الوضع التجريبي.",
  ...
  return (
    <div className="space-y-24">
      <section>
        ...
        <Reveal>
          <div className="glass neon-ring panel-shine relative overflow-hidden rounded-3xl p-8 sm:p-10">
          ...
          {VALUES.map((item, i) => (
            <Reveal key={item.title} delay={i * 60}>
              <div className="glass panel-shine h-full rounded-3xl p-6">
                ...
                <p className="mt-2 leading-7 text-sm text-muted-foreground">{item.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
      ...
      <Reveal>
        <div className="glass neon-ring panel-shine relative overflow-hidden rounded-3xl p-8 text-center sm:p-10">
