  ...
  return (
    <div className="space-y-16">
      ...
      <section className="mx-auto grid max-w-5xl gap-5 lg:grid-cols-[0.95fr_1.05fr]">
        <Reveal>
          <div className="glass panel-shine h-full space-y-5 rounded-3xl p-6 sm:p-7">
        ...
        <Reveal delay={80}>
          <form onSubmit={submit} className="glass panel-shine space-y-4 rounded-3xl p-6 sm:p-7">
            {sent ? (
